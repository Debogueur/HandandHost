...
function CroppedImages(props) {
    ...
    const [crop, setCrop] = useState({ unit: '%', x: 10, y: 10, width: 30, height: 30, aspect: 16 / 9 });
    ...
    const onCropChange = (newCrop, percentCrop) => {
        setCrop(prevCrop => ({
            ...prevCrop,
            ...newCrop,
            x: newCrop.x !== undefined ? newCrop.x : prevCrop.x,
            y: newCrop.y !== undefined ? newCrop.y : prevCrop.y,
            width: newCrop.width !== undefined ? newCrop.width : prevCrop.width,
            height: newCrop.height !== undefined ? newCrop.height : prevCrop.height,
        }));
    };
