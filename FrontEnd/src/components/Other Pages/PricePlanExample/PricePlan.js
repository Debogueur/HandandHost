                ...
                <div className="row mb-5 mt-4">
                    ...
                    <div className="d-inline-flex justify-content-center mx-auto">
                        <ul className="nav nav-tabs tab-body-header rounded invoice-set" role="tablist">
                            <li className="nav-item"><Link className="nav-link" to="#!" >Month Plan</Link></li>
                            <li className="nav-item"><Link className="nav-link active" to="#!">Yearly Plan</Link></li>
                        </ul>
                    </div>
                </div>
                            ...
                            return <div key={'s' + i} className="col-xxl-3 col-xl-4 col-lg-4 col-sm-12 lift">
                                <div className="card">
                                    ...
                                    <div className="card-body text-center">
                                        <Link to="#!" className="btn btn-white border lift">Get Started</Link>
                                    </div>
                                </div>
                            </div>
                        })
