        ...
        <div className="card mb-4 border-0 lift">
            <div className="card-header py-3 d-flex flex-wrap  justify-content-between align-items-center bg-transparent border-bottom-0">
                <div>
                    ...
                    <small className="text-muted">{subTitle1 ? subTitle1 : ""} <Link to="#!">{linkText ? linkText : ""}</Link> {subTitle2 ? subTitle2 : ""}</small>
                </div>
                <Dropdown drop="left">
                                ...
                                <tbody>
                                    {
                                        tableData.rows.map((d, i) => {
                                            return <tr key={'tableRows' + i}>
                                                <td>{d.no}</td>
                                                <td><Link to={d.SOURCE} target="_blank" rel="noopener noreferrer">{d.SOURCE}</Link></td>
                                                <td>{d.VISITS}</td>
                                                <td>{d.AVGTIME}</td>
                                                <td>{d.BOUNCERATE}</td>
                                            </tr>
