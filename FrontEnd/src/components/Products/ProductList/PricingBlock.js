    ...
    return (
        <div className="price-range-block">
            <div className="filter-title">
                <Link className="title" data-bs-toggle="collapse" to="#pricingTwo" role="button" onClick={() => { setCallopsPrice(!callopsPrice) }} aria-expanded={callopsPrice}>Pricing Range</Link>
            </div>
