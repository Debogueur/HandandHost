                            ...
                            <div className="d-flex mb-3 pb-3 border-bottom flex-wrap">
                                ...
                                <div className="d-flex align-items-center">
                                    <span className="mb-2 me-3">
                                        <Link to='#!' className="rating-link active"><i className="bi bi-star-fill text-warning"></i></Link>
                                        <Link to='#!' className="rating-link active"><i className="bi bi-star-fill text-warning"></i></Link>
                                        <Link to='#!' className="rating-link active"><i className="bi bi-star-fill text-warning"></i></Link>
                                        <Link to='#!' className="rating-link active"><i className="bi bi-star-fill text-warning"></i></Link>
                                        <Link to='#!' className="rating-link active"><i className="bi bi-star-half text-warning"></i></Link>
                                    </span>
                                </div>
                            </div>
