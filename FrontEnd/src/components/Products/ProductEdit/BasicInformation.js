...
function BasicInformation() {
    const [description, setDescription] = useState(`<p>This is some sample content.</p>
        <ul>
                ...
                <form>
                    <div className="row g-3 align-items-center">
                        ...
                        <div className="col-md-12">
                            ...
                            <TiptapEditor content={description} onChange={setDescription} placeholder="Start typing your product description..." />
                        </div>
                    </div>
                </form>
            </div>
