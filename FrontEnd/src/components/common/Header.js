...
function Header(props) {
    ...
    // 2. Add this to log whenever username or email changes
    useEffect(() => {
    ...
    const handleLogout = () => {
        ...
        localStorage.clear();
        // OR use localStorage.removeItem('your_token_key'); if you want to keep other settings

        // 2. Redirect (Optional: most people redirect to sign-in)
                    ...
                    <div className="container-xxl">
                        <div className="h-right d-flex align-items-center order-1">  
                            ...
                            <Dropdown className="zindex-popover mx-2">
                                <Dropdown.Toggle as='a' className="nav-Dropdown.Itemnk dropdown-toggle pulse" to="#!" >
                                    <Image src={GB} alt='' />
                                </Dropdown.Toggle>
                                <Dropdown.Menu className="dropdown-menu rounded-lg shadow border-0 dropdown-animation dropdown-menu-md-end p-0 m-0 mt-5 ">
                                    <div className="card border-0">
                                        <ul className="list-unstyled list py-2 px-3">
                                            <li>
                                                <Dropdown.Item to="#!"><Image src={GB} alt="" /> English</Dropdown.Item>
                                            </li>
                                            <li>
                                                <Dropdown.Item to="#!"><Image src={DE} alt="" /> German</Dropdown.Item>
                                            </li>
                                            <li>
                                                <Dropdown.Item to="#!"><Image src={FR} alt="" /> French</Dropdown.Item>
                                            </li>
                                            <li>
                                                <Dropdown.Item to="#!"><Image src={IT} alt="" /> Italian</Dropdown.Item>
                                            </li>
                                            <li>
                                                <Dropdown.Item to="#!"><Image src={RU} alt="" /> Russian</Dropdown.Item>
                                            </li>
                                        </ul>
                                    </div>
                                </Dropdown.Menu>
                            ...
                            <Dropdown className="dropdown user-profilem ms-2 ms-sm-3 d-flex align-items-center zindex-popover">
                                ...
                                <p className="mb-0 text-end line-height-sm "><span className="font-weight-bold">{username || "Guest"}</span></p>
                                <small>{email || "No email provided"}</small>
                                </div>
                                <Dropdown.Toggle as='a' className="nav-link dropdown-toggle pulse p-0 mb-3" to="#!" role="button">
                                        ...
                                        <div className="card-body pb-0 ">
                                            <div className="d-flex py-1">
                                                ...
                                                <div className="flex-fill ms-3">
                                                    <p className="mb-0">
                                                        <span className="font-weight-bold">{username || "Guest"}</span></p>
                                                        <small>{email || "No email provided"}</small>
                            ...
                            <div className="setting ms-2">
                                <Link to='#!' onClick={(val) => {props.onOpenModalSetting(true) }} ><i className="icofont-gear-alt fs-5"></i></Link>
                            </div>
                        </div>
