...
function AddModal(props) {
    const { darkMode, openmodal, highcontrast, rtlmode } = props.main
                        ...
                        <ul className="list-unstyled choose-skin mb-2 mt-1" >
                            <li data-theme="dynamic " onClick={() => { Changetheme('Dynamic') }}>
                                <div className='p-1 m-2'>
                                    <Link className="dynamic text-light" data-bs-toggle="collapse" to='#size' role="button" onClick={() => { setOncollapse({ oncollapse: !oncollapse }) }}>
                                        <i className="icofont-paint me-2"></i>Click to Dynamic Setting</Link>
                                </div>
                            </li>
                        </ul>
