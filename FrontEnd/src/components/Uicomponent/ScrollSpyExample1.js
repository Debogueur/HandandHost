...
function ScrollSpyExample1 (){
                        ...
                        <div className={basicT === "Preview"?"tab-pane fade active show":"tab-pane fade"} id="nav-Preview1" role="tabpanel">
                            <nav id="navbar-example1" className="navbar navbar-light bg-light px-3">
                                ...
                                <ul className="nav nav-pills">
                                    <li className="nav-item"><Link className="nav-link" to="#fat">@fat</Link></li>
                                    <li className="nav-item"><Link className="nav-link" to="#mdo">@mdo</Link></li>
    ...
    <ul class="nav nav-pills">
        <li class="nav-item"><Link class="nav-link" to="#fat">@fat</Link></li>
        <li class="nav-item"><Link class="nav-link" to="#mdo">@mdo</Link></li>
        <li class="nav-item dropdown">
            <Link class="nav-link dropdown-toggle" data-toggle="dropdown" to="#!" role="button" aria-expanded="false">Dropdown</Link>
            <ul class="dropdown-menu dropdown-menu-end">
                <li><Link class="dropdown-item" to="#one">one</Link></li>
                <li><Link class="dropdown-item" to="#two">two</Link></li>
                <li><hr class="dropdown-divider"></li>
                <li><Link class="dropdown-item" to="#three">three</Link></li>
            </ul>
        </li>
    </ul>
</nav>
