...
function CardsLyouts() {
    ...
    <div className="col-lg-8 col-sm-12">
        <div className="card">
            ...
            <p>Cards are built with as little markup and styles as possible, but still manage to deliver a ton of control and customization. Built with flexbox, they offer easy alignment and mix well with other Bootstrap components. They have no <code>margin</code> by default, so use <Link to="/docs/5.0/utilities/spacing/">spacing utilities</Link> as needed.</p>
            <p>Below is an example of a basic card with mixed content and a fixed width. Cards have no fixed width to start, so they’ll naturally fill the full width of its parent element. This is easily customized with our various <Link to="#sizing">sizing options</Link>.</p>
...
<div className="card" style={{width:'18rem'}}>
    ...
    <div className="col-sm-6">
        <div className="card">
            ...
            <p>Use our handful of <Link to="https://v5.getbootstrap.com/docs/5.0/utilities/sizing/">available sizing utilities</Link> to quickly set a card’s width.</p>
            <div className="bd-example mb-5">
...
<div className="card w-50">
    ...
    <div className="card-body">
        ...
        <Link to="#!" className="btn btn-primary">Go somewhere</Link>
            ...
            <p>You can quickly change the text alignment of any card—in its entirety or specific parts—with our <Link to="https://v5.getbootstrap.com/docs/5.0/utilities/text/#text-alignment">text align classes</Link>.</p>
            <div className="bd-example mb-5">
                <div className="card" style={{width:'18rem'}}>
                    <div className="card-body">
                        <h5 className="card-title">Special title treatment</h5>
...
<div className="card text-end" style={{width:'18rem'}}>
    <div className="card-body">
        ...
        <Link to="#!" className="btn btn-primary">Go somewhere</Link>
            ...
            <p>Add some navigation to a card’s header (or block) with Bootstrap’s <Link to="https://v5.getbootstrap.com/docs/5.0/components/navs/">nav components</Link>.</p>
            <div className="bd-example mb-5">
                <div className="card text-center">
                    <div className="card-header">
                        <ul className="nav nav-tabs card-header-tabs">
                            <li className="nav-item"><Link className="nav-link active" aria-current="true" to="#!">Active</Link></li>
                            <li className="nav-item"><Link className="nav-link" to="#!">Link</Link></li>
                            <li className="nav-item"><Link className="nav-link disabled" to="#!"  aria-disabled="true">Disabled</Link></li>
                        </ul>
                    </div>
                    <div className="card-body">
                        <h5 className="card-title">Special title treatment</h5>
    ...
    <div className="card-header">
        <ul className="nav nav-tabs card-header-tabs">
            <li className="nav-item"><Link className="nav-link active" aria-current="true" to="#!">Active</Link></li>
            <li className="nav-item"><Link className="nav-link" to="#!">Link</Link></li>
            <li className="nav-item"><Link className="nav-link disabled" to="#!" tabindex="-1" aria-disabled="true">Disabled</Link></li>
        </ul>
    </div>
    <div className="card-body">
        <h5 className="card-title">Special title treatment</h5>
                ...
                <div className="card text-center">
                    <div className="card-header">
                        <ul className="nav nav-pills card-header-pills">
                            <li className="nav-item"><Link className="nav-link active" to="#!">Active</Link></li>
                            <li className="nav-item"><Link className="nav-link" to="#!">Link</Link></li>
                            <li className="nav-item"><Link className="nav-link disabled" to="#!" aria-disabled="true">Disabled</Link></li>
                        </ul>
                    </div>
...
<div className="card mb-3" >
    <div className="row g-0">
        ...
        <div className="col-md-8">
            ...
            <p>Use <Link to="https://v5.getbootstrap.com/docs/5.0/utilities/colors/">text and background utilities</Link> to change the appearance of a card.</p>
            <div className="bd-example mb-5">
...
<div className="card text-white bg-dark mb-3" style={{width:'18rem'}}">
    ...
    <div className="card-body">
        ...
        <p className="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
            ...
            <p>Use <Link to="https://v5.getbootstrap.com/docs/5.0/utilities/borders/">border utilities</Link> to change just the <code>border-color</code> of a card. Note that you can put <code>.text-{"{color}"}</code> classes on the parent <code>.card</code> or a subset of the card’s contents as shown below.</p>
            <div className="bd-example mb-5">
...
<div className="row row-cols-1 row-cols-md-3 g-4">
    ...
    <div className="col">
        <div className="card h-100">
            ...
            <p>In <code>v4</code> we used a CSS-only technique to mimic the behavior of <Link to="https://masonry.desandro.com/">Masonry</Link>-like columns, but this technique came with lots of unpleasant <Link to="https://github.com/twbs/bootstrap/pull/28922">side effects</Link>. If you want to have this type of layout in <code>v5</code>, you can just make use of Masonry plugin. <strong>Masonry is not included in Bootstrap</strong>, but we’ve made a <Link to="https://v5.getbootstrap.com/docs/5.0/examples/masonry/">demo example</Link> to help you get started.</p>
            </div>
        </div>
    </div>
    );
