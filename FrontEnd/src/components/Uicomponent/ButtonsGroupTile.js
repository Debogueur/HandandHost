...
function ButtonsGroupTile () {
    ...
    <button type="button" className="btn btn-primary">Right</button>
                                    ...
                                    <p>These classes can also be added to groups of links, as an alternative to the <Link to="/docs/5.0/components/navs/"><code>.nav</code> navigation components</Link>.</p>
                                    <div className="bd-example mb-5">
    ...
    <button type="button" className="btn btn-outline-primary">Right</button>
                                    ...
                                    <p>Combine button-like checkbox and radio <Link to="/docs/5.0/forms/checks-radios/">toggle buttons</Link> into a seamless looking button group.</p>
                                    <div className="bd-example mb-5">
