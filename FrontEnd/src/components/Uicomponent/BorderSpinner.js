...
function BorderSpinner() {
    ...
    return (
        <div className="border-top mt-5 pt-3">
            ...
            <p>The border spinner uses <code>currentColor</code> for its <code>border-color</code>, meaning you can customize the color with <Link to="https://v5.getbootstrap.com/docs/5.0/utilities/colors/">text color utilities</Link>. You can use any of our text color utilities on the standard spinner.</p>
