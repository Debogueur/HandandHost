    ...
    return (
        <div className="border-top mt-5 pt-3">
            ...
            <ul className="nav nav-tabs tab-card px-3 border-bottom-0" role="tablist">
                <li className="nav-item"><Link className="nav-link smodal-nav-link-1 active" to="#!" onClick={(e) => { e.preventDefault(); tabEvent(e, "smodal-nav-Preview1", "smodal-tab-pane-1", "smodal-nav-link-1") }} >Preview</Link></li>
                <li className="nav-item"><Link className="nav-link smodal-nav-link-1" to="#!" onClick={(e) => { e.preventDefault(); tabEvent(e, "smodal-nav-HTML1", "smodal-tab-pane-1", "smodal-nav-link-1") }} >HTML</Link></li>
            </ul>
