...
function AlertTile() {
    ...
    return (
        <div className="col-12">
            <div className="card p-4 bd-content">
                ...
                <p>Alerts are available for any length of text, as well as an optional close button. For proper styling, use one of the eight <strong>required</strong> contextual classes (e.g., <code>.alert-success</code>). For inline dismissal, use the <Link to="#dismissing">alerts JavaScript plugin</Link>.</p>
                <div className="bd-example mb-5">
                    ...
                    <SyntaxHighlighter language="html" style={a11yLight} className="language-html">
                        {`    <Alert variant='primary'>This is a primary alert—check it out!</Linklert>
    <Alert variant='secondary'>This is a secondary alert—check it out!</Linklert>
    <Alert variant='success'>This is a success alert—check it out!</Linklert>
    <Alert variant='danger'>This is a danger alert—check it out!</Linklert>
    <Alert variant='warning'>This is a warning alert—check it out!</Linklert>
    <Alert variant='info'>This is a info alert—check it out!</Linklert>
    <Alert variant='light'>This is a light alert—check it out!</Linklert>
    <Alert variant='dark'>This is a dark alert—check it out!</Linklert>`}
                    </SyntaxHighlighter>
                </div>
                ...
                <div className="bd-example mb-5">
                    {
                        [
                            ...
                            <Alert key={idx} variant={variant}>
                                This is a {variant} alert with{' '}<Alert.Link to="#">an example link</Alert.Link>. Give it a click if youlike.
                            </Alert>
                        ))
                    }

                    <SyntaxHighlighter language="html" style={a11yLight} className="language-html">
                        {`    <Alert variant='primary'>This is a primary alert with{' '}<Alert.Link to="#!">an example link</Alert.Link>. Give it a click if youlike.</Alert>
    <Alert variant='secondary'>This is a secondary alert with{' '}<Alert.Link to="#!">an example link</Alert.Link>. Give it a click if youlike.</Alert>
    <Alert variant='success'>This is a success alert with{' '}<Alert.Link to="#!">an example link</Alert.Link>. Give it a click if youlike.</Alert>
    <Alert variant='danger'>This is a danger alert with{' '}<Alert.Link to="#!">an example link</Alert.Link>. Give it a click if youlike.</Alert>
    <Alert variant='warning'>This is a warning alert with{' '}<Alert.Link to="#!">an example link</Alert.Link>. Give it a click if youlike.</Alert>
    <Alert variant='info'>This is a info alert with{' '}<Alert.Link to="#!">an example link</Alert.Link>. Give it a click if youlike.</Alert>
    <Alert variant='light'>This is a light alert with{' '}<Alert.Link to="#!">an example link</Alert.Link>. Give it a click if youlike.</Alert>
    <Alert variant='dark'>This is a dark alert with{' '}<Alert.Link to="#!">an example link</Alert.Link>. Give it a click if youlike.</Alert>`}
                    </SyntaxHighlighter>
                </div>
    ...
    <p className="mb-0">Whenever you need to, be sure to use margin utilities to keep things nice and tidy.</p>
                ...
                <ul>
                    ...
                    <li>Add a <Link to="/docs/5.0/components/close-button/">close button</Link> and the <code>.alert-dismissible</code> class, which adds extra padding to the right of the alert and positions the close button.</li>
