...
<button type="button" className="btn btn-link">Link</button>`}
            ...
            <div className="bd-example mb-5">
                <Link className="btn btn-primary me-1" to="#!" role="button">Link</Link>
...
<button type="button" className="btn btn-secondary btn-lg" disabled="">Button</button>`}
            ...
            <div className="bd-example mb-5">
                <Link to="#!" className="btn btn-primary btn-lg disabled  me-1" role="button" aria-disabled="true">Primary link</Link>
                <Link to="#!" className="btn btn-secondary btn-lg disabled" role="button" aria-disabled="true">Link</Link>
                <SyntaxHighlighter language="javascript" className="mt-2 language-html py-2 px-2" style={a11yLight}>
                    {`<Link to="#" className="btn btn-primary btn-lg disabled" tabindex="-1" role="button" aria-disabled="true">Primary link</Link>
<Link to="#" className="btn btn-secondary btn-lg disabled" tabindex="-1" role="button" aria-disabled="true">Link</Link>`}
            ...
            <div className="card p-4 mb-5 shadow-sm">
                Visually, these toggle buttons are identical to the <Link to="https://v5.getbootstrap.com/docs/5.0/forms/checks-radios/#checkbox-toggle-buttons">checkbox toggle buttons</Link>. However, they are conveyed differently by assistive technologies: the checkbox toggles will be announced by screen readers as “checked”/“not checked” (since, despite their appearance, they are fundamentally still checkboxes), whereas these toggle buttons will be announced as “button”/“button pressed”. The choice between these two approaches will depend on the type of toggle you are creating, and whether or not the toggle will make sense to users when announced as a checkbox or as an actual button.
            </div>
...
<button type="button" className="btn btn-primary" disabled="" data-toggle="button" autocomplete="off">Disabled toggle button</button>`}
            ...
            <div className="bd-example mb-5">
                <Link to="#!" className="btn btn-primary me-1" role="button" data-bs-toggle="button">Toggle link</Link>
                <Link to="#!" className="btn btn-primary active me-1" role="button" data-bs-toggle="button" aria-pressed="true">Active toggle link</Link>
                ...
                <SyntaxHighlighter language="javascript" className="mt-2 language-html py-2 px-2" style={a11yLight}>
                    {`<Link to="#" className="btn btn-primary" role="button" data-toggle="button">Toggle link</Link>
<Link to="#" className="btn btn-primary active" role="button" data-toggle="button" aria-pressed="true">Active toggle link</Link>
<Link to="#" className="btn btn-primary disabled" tabindex="-1" aria-disabled="true" role="button" data-toggle="button">Disabled toggle link</Link>`}
                </SyntaxHighlighter>
            </div>
