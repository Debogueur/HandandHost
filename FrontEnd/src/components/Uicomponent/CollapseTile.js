            ...
            <div className="card">
                <div className="card-body">
                    ...
                    <div className="card card-callout mb-3">
                        <div className="card-body">
                            The animation effect of this component is dependent on the <code>prefers-reduced-motion</code> media query. See the <Link to="https://v5.getbootstrap.com/docs/5.0/getting-started/accessibility/#reduced-motion">reduced motion section of our accessibility documentation</Link>.
                        </div>
                    </div>
                        ...
                        <Tab.Container id="left-tabs-example" defaultActiveKey="preview1" className="px-3">
                            ...
                            <Tab.Content>
                                <Tab.Pane eventKey="preview1">
                                    <div className="card-body">
                                        <p>
                                            <Link className="btn btn-primary collapsed me-2" to="#!" onClick={(e) => { e.preventDefault(); callopsEvent("collapseExample") }}>
                                                Link with href
                                            </Link>
                        ...
                        <Tab.Container id="left-tabs-example" defaultActiveKey="preview1" className="px-3">
                            ...
                            <Tab.Content>
                                <Tab.Pane eventKey="preview1">
                                    <div className="card-body">
                                        <p>
                                            <Link className="btn btn-primary me-2" to="#!" onClick={(e) => { e.preventDefault(); callopsEvent("multiCollapseExample1") }}>Toggle first element</Link>
        ...
        <div className="multi-collapse collapse" id="multiCollapseExample2" >
            <div className="card card-body">
                Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. Nihil anim keffiyeh helvetica, craft beer labore wes anderson cred nesciunt sapiente ea proident.
                    ...
                    <p>Using the <Link to="https://v5.getbootstrap.com/docs/5.0/components/card/">card</Link> component, you can extend the default collapse behavior to create an accordion. To properly achieve the accordion style, be sure to use <code>.accordion</code> as a wrapper.</p>
                    <div className="bd-example mb-5">
                        <Tab.Container id="left-tabs-example" defaultActiveKey="preview1" className="px-3">
                            <Nav variant="tabs" className="tab-card">
                                <Nav.Item>
        ...
        <div id="collapseThree" className="collapse"  data-parent="#accordionExample">
            <div className="card-body">
                Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch 3 wolf moon tempor, sunt aliqua put a bird on it squid single-origin coffee nulla assumenda shoreditch et. Nihil anim keffiyeh helvetica, craft beer labore wes anderson cred nesciunt sapiente ea proident. Ad vegan excepteur butcher vice lomo. Leggings occaecat craft beer farm-to-table, raw denim aesthetic synth nesciunt you probably haven't heard of them accusamus labore sustainable VHS.
                    ...
                    <p>Note that Bootstrap’s current implementation does not cover the various <em>optional</em> keyboard interactions described in the <Link to="https://www.w3.org/TR/wai-aria-practices-1.1/#accordion">WAI-ARIA Authoring Practices 1.1 accordion pattern</Link> - you will need to include these yourself with custom JavaScript.</p>
    ...
    return new bootstrap.Collapse(collapseEl)
                    ...
                    <div className="card card-callout mb-3">
                        <div className="card-body">
                            ...
                            <p><Link to="/docs/5.0/getting-started/javascript/#asynchronous-functions-and-transitions">See our JavaScript documentation for more information</Link>.</p>
                        </div>
                    </div>
