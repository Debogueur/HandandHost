    ...
    return (
        <div className="border-top mt-5 pt-3">
            <ul className="nav nav-tabs tab-card px-3 border-bottom-0" role="tablist">
                <li className="nav-item"><Link className="nav-link bnodal-nav-link-1 active" data-bs-toggle="tab" to="#!" onClick={(e)=>{e.preventDefault(); tabEvent(e,"bnodal-nav-Preview1","bnodal-tab-pane-1","bnodal-nav-link-1") }}>Preview</Link></li>
                <li className="nav-item"><Link className="nav-link bnodal-nav-link-1" data-bs-toggle="tab" to="#!" onClick={(e)=>{e.preventDefault(); tabEvent(e,"bnodal-nav-HTML1","bnodal-tab-pane-1","bnodal-nav-link-1") }}>HTML</Link></li>
            </ul>
                ...
                <div className="card-body">
                    <div className="tab-content">
                        <div className="tab-pane fade bnodal-tab-pane-1 active show" id="bnodal-nav-Preview1" role="tabpanel">
                            <ul className="nav">
                                <li className="nav-item"><Link className="nav-link active" aria-current="page" to="#!">Active</Link></li>
                        ...
                        <SyntaxHighlighter language="javascript" className="mt-2 language-html py-2 px-2"  style={a11yLight}>
                                {`<!-- Nav: left alignment -->
<ul class="nav">
    <li class="nav-item"><Link class="nav-link active" aria-current="page" to="#">Active</Link></li>
    <li class="nav-item"><Link class="nav-link" to="#">Link</Link></li>
    <li class="nav-item"><Link class="nav-link" to="#">Link</Link></li>
    <li class="nav-item"><Link class="nav-link disabled" to="#"  aria-disabled="true">Disabled</Link></li>
</ul>
...
<ul class="nav justify-content-end">
    ...
    <li class="nav-item"><Link class="nav-link disabled" to="#"  aria-disabled="true">Disabled</Link></li>
            ...
            <ul className="nav nav-tabs tab-card px-3 border-bottom-0" role="tablist">
                <li className="nav-item"><Link className="nav-link bnodal-nav-link-2 active" to="#nav-Preview2" onClick={(e)=>{e.preventDefault(); tabEvent(e,"bnodal-nav-Preview2","bnodal-tab-pane-2","bnodal-nav-link-2") }}>Preview</Link></li>
                <li className="nav-item"><Link className="nav-link bnodal-nav-link-2" to="#nav-HTML2" onClick={(e)=>{e.preventDefault(); tabEvent(e,"bnodal-nav-HTML2","bnodal-tab-pane-2","bnodal-nav-link-2") }} >HTML</Link></li>
            </ul>
            <div className="card mb-3">
                <div className="card-body">
                    <div className="tab-content">
    ...
    <Link class="nav-link disabled" to="#"  aria-disabled="true">Disabled</Link>
            ...
            <ul className="nav nav-tabs tab-card px-3 border-bottom-0" role="tablist">
                <li className="nav-item"><Link className="nav-link bnodal-nav-link-3 active" to="#nav-Preview3" onClick={(e)=>{e.preventDefault(); tabEvent(e,"bnodal-nav-Preview3","bnodal-tab-pane-3","bnodal-nav-link-3") }}>Preview</Link></li>
                <li className="nav-item"><Link className="nav-link bnodal-nav-link-3" to="#nav-HTML3" onClick={(e)=>{e.preventDefault(); tabEvent(e,"bnodal-nav-HTML3","bnodal-tab-pane-3","bnodal-nav-link-3") }}>HTML</Link></li>
            </ul>
            <div className="card mb-3">
                <div className="card-body">
                    <div className="tab-content">
