...
function CarouselUITile () {
    ...
    <div className="col-lg-8 col-sm-12">
        <div className="card">
            ...
            <p>In browsers where the <Link to="https://www.w3.org/TR/page-visibility/">Page Visibility API</Link> is supported, the carousel will avoid sliding when the webpage is not visible to the user (such as when the browser tab is inactive, the browser window is minimized, etc.).</p>
...
<Carousel indicators = {true}>
    ...
    <Carousel.Item>
        ...
        />
            ...
            <p>Add captions to your slides easily with the <code>.carousel-caption</code> element within any <code>.carousel-item</code>. They can be easily hidden on smaller viewports, as shown below, with optional <Link to="https://v5.getbootstrap.com/docs/5.0/utilities/display/">display utilities</Link>. We hide them initially with <code>.d-none</code> and bring them back on medium-sized devices with <code>.d-md-block</code>.</p>
            <div className="bd-example mb-5">
                <div className="card">
                    <div className="card-body">
                    <Carousel indicators = {true}>
