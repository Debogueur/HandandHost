                                ...
                                <div className="col-4">
                                    <nav id="navbar-example2" className="navbar navbar-light bg-light flex-column">
                                        ...
                                        <nav className="nav nav-pills flex-column">
                                            ...
                                            <nav className="nav nav-pills flex-column">
                                                <Link className="nav-link ms-3 my-1" to="#item-1-1">Item 1-1</Link>
                                                <Link className="nav-link ms-3 my-1" to="#item-1-2">Item 1-2</Link>
                                            </nav>
                                            <Link className="nav-link" to="#item-2">Item 2</Link>
                                            <Link className="nav-link" to="#item-3">Item 3</Link>
                                            <nav className="nav nav-pills flex-column">
                                                <Link className="nav-link ms-3 my-1" to="#item-3-1">Item 3-1</Link>
                                                <Link className="nav-link ms-3 my-1" to="#item-3-2">Item 3-2</Link>
                                            </nav>
                                        </nav>
                                    </nav>
                                </div>
    ...
    <div class="col-4">
        <nav id="navbar-example2" class="navbar navbar-light bg-light flex-column">
            ...
            <nav class="nav nav-pills flex-column">
                <Link class="nav-link" to="#item-1">Item 1</Link>
                <nav class="nav nav-pills flex-column">
                    <Link class="nav-link ms-3 my-1" to="#item-1-1">Item 1-1</Link>
                    <Link class="nav-link ms-3 my-1" to="#item-1-2">Item 1-2</Link>
                </nav>
                <Link class="nav-link" to="#item-2">Item 2</Link>
                <Link class="nav-link" to="#item-3">Item 3</Link>
                <nav class="nav nav-pills flex-column">
                    <Link class="nav-link ms-3 my-1" to="#item-3-1">Item 3-1</Link>
                    <Link class="nav-link ms-3 my-1" to="#item-3-2">Item 3-2</Link>
                </nav>
            </nav>
        </nav>
    </div>
