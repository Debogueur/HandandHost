...
function FormsDropdown() {
    ...
    return (
        <div className="border-top mt-5 pt-3">
            ...
            <p>Put a form within a dropdown menu, or make it into a dropdown menu, and use <Link to="https://v5.getbootstrap.com/docs/5.0/utilities/spacing/">margin or padding utilities</Link> to give it the negative space you require.</p>

            <ul className="nav nav-tabs tab-card px-3 border-bottom-0" role="tablist">
                <li className="nav-item"><Link className="nav-link Forms-nav-link-1 active" to="#!" onClick={(e) => { e.preventDefault(); tabEvent(e, "Forms-nav-Preview1", "Forms-tab-pane-1", "Forms-nav-link-1") }}>Preview</Link></li>
                <li className="nav-item"><Link className="nav-link Forms-nav-link-1" to="#!" onClick={(e) => { e.preventDefault(); tabEvent(e, "Forms-nav-Preview2", "Forms-tab-pane-1", "Forms-nav-link-1") }}>HTML</Link></li>
            </ul>
