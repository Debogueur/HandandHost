...
//                 <li className="nav-item"><Link className="nav-link blist-nav-link-1 active" to="#!" onClick={(e)=>{e.preventDefault(); this.tabEvent(e,"blist-nav-Preview1","blist-tab-pane-1","blist-nav-link-1") }}>Preview</Link></li>
//                 <li className="nav-item"><Link className="nav-link blist-nav-link-1" to="#!" onClick={(e)=>{e.preventDefault(); this.tabEvent(e,"blist-nav-HTML1","blist-tab-pane-1","blist-nav-link-1") }}>HTML</Link></li>
//             </ul>
...
//             </div>
//             <ul className="nav nav-tabs tab-card px-3 border-bottom-0" role="tablist">
//                 <li className="nav-item"><Link className="nav-link blist-nav-link-2 active" to="#!" onClick={(e)=>{e.preventDefault(); this.tabEvent(e,"blist-nav-Preview2","blist-tab-pane-2","blist-nav-link-2") }}>Preview</Link></li>
//                 <li className="nav-item"><Link className="nav-link blist-nav-link-2" to="#!" onClick={(e)=>{e.preventDefault(); this.tabEvent(e,"blist-nav-HTML2","blist-tab-pane-2","blist-nav-link-2") }}>HTML</Link></li>
//             </ul>
//             <div className="card mb-3 bg-transparent">
//                 <div className="card-body">
//                     <div className="tab-content">
...
//             <ul className="nav nav-tabs tab-card px-3 border-bottom-0" role="tablist">
//                 <li className="nav-item"><Link className="nav-link blist-nav-link-3 active" to="#!" onClick={(e)=>{e.preventDefault(); this.tabEvent(e,"blist-nav-Preview3","blist-tab-pane-3","blist-nav-link-3") }} >Preview</Link></li>
//                 <li className="nav-item"><Link className="nav-link blist-nav-link-3" to="#!" onClick={(e)=>{e.preventDefault(); this.tabEvent(e,"blist-nav-HTML3","blist-tab-pane-3","blist-nav-link-3") }} >HTML</Link></li>
//             </ul>
//             <div className="card mb-3 bg-transparent">
//                 <div className="card-body">
//                     <div className="tab-content">
