...
function CouponsOInfo () {
    const [couponCode, setCouponCode] = useState("AXXQT-2547");
                    ...
                    <form>
                        <div className="row g-3 align-items-center">
                            ...
                            <div className="col-md-6">
                                ...
                                <input type="text" className="form-control" value={couponLimit} onChange={e => setCouponLimit(e.target.value)} />
                            </div>
                            ...
                            <div className="col-md-12">
                                ...
                                <input type="text" className="form-control" value={discountValue} onChange={e => setDiscountValue(e.target.value)} />
                            </div>
                        </div>
