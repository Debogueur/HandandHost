                    ...
                    <div className="col-12">
                        ...
                        <div className="mb-3 pt-3 card" style={{ fontSize: 16 }}>
                            ...
                            <div className="card-body">
                                ...
                                <p>If you really like our work, design, performance and support then <Link to="https://themeforest.net/downloads"> please don't forgot to rate us</Link> on Themeforest,<br /> it really motivate us to provide something better.
                                    <span className="ms-2">
                    ...
                    <div className="col-12">
                        <div className="mb-3 pt-3 card">
                            ...
                            <div className="card-body">
                                ...
                                <ul>
                                    <li><strong>Node.js and NPM:</strong>  You can download Node.js from <Link to="https://nodejs.org" className="text-primary text-decoration-underline">NodeJS</Link>. NPM comes bundled with Node.js</li>
                                    ...
                                    <li><strong>Further help:</strong> To get more help on the project setup, go and check out <Link to="https://reactjs.org/"  className="text-primary text-decoration-underline">https://reactjs.org/</Link>.</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                ...
                                <div className="table-responsive">
                                    <table className="table table-hover">
                                        <tbody>
                                            <tr>
                                                <td>Google font</td>
                                                <td><Link to="https://fonts.google.com/">https://fonts.google.com/</Link></td>
                                            </tr>
                                            <tr>
                                                <td>Bootstrap</td>
                                                <td><Link to="https://v5.getbootstrap.com/">https://v5.getbootstrap.com/</Link></td>
                                            </tr>
                                            <tr>
                                                <td>Jquery</td>
                                                <td><Link to="https://jquery.com/">https://jquery.com/</Link></td>
                                            </tr>
                                            <tr>
                                                <td>SASS</td>
                                                <td><Link to="https://sass-lang.com/">https://sass-lang.com/</Link></td>
                                            </tr>
                                            <tr>
                                                <td>Grunt</td>
                                                <td><Link to="https://gruntjs.com/">https://gruntjs.com/</Link></td>
                                            </tr>
                                            <tr>
                                                <td>NPM</td>
                                                <td><Link to="https://www.npmjs.com/">https://www.npmjs.com/</Link></td>
                                            </tr>
                                            <tr>
                                                <td>Fontawesome</td>
                                                <td><Link to="https://fontawesome.com/v4.7.0/">https://fontawesome.com/v4.7.0/</Link></td>
                                            </tr>
                                            <tr>
                                                <td>Icon Font</td>
                                                <td><Link to="https://icofont.com/icons">https://icofont.com/icons</Link></td>
                                            </tr>
                                            <tr>
                                                <td>Apex Charts</td>
                                                <td><Link to="https://apexcharts.com/">https://apexcharts.com/</Link></td>
                                            </tr>
                                            <tr>
                                                <td>Sparkline Charts</td>
                                                <td><Link to="https://omnipotent.net/jquery.sparkline/#s-about">https://omnipotent.net/jquery.sparkline/#s-about</Link></td>
                                            </tr>
                                            <tr>
                                                <td>Fullcalendar</td>
                                                <td><Link to="https://fullcalendar.io/">https://fullcalendar.io/</Link></td>
                                            </tr>
                                            <tr>
                                                <td>Pexels</td>
                                                <td><Link to="https://www.pexels.com/">https://www.pexels.com/</Link></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                                        ...
                                        <div className="card overflow-hidden mb-3">
                                            <div className="bg-primary py-5 px-4 text-light">
                                                ...
                                                <span className="small">Once again, thank you so much for purchasing this template. As I said at the beginning, I'd be glad to help you if you have any questions relating to this template.
                                                    If you really like our work, design, performance and support then <Link className="text-warning" to="https://themeforest.net/downloads"> please don't forgot to rate us</Link> on Themeforest, it really motivate us to provide something better.</span>
                                            </div>
                                            <div className="p-4">
                                                ...
                                                <div className="mt-4 mb-2">
                                                    <Link to="http://www.pixelwibes.com"  rel="noreferrer" className="btn btn-primary">Hire Us</Link>
                                                </div>
                                                ...
                                                <div className="mt-4 mb-2">
                                                    <Link to="http://pixelwibes.com/" className="btn btn-primary">Check out the guide</Link>
                                                </div>
                                                <div className="dividers-block"></div>
                                                <h6>Get answers</h6>
                                                <span>Visit the help centre for answers to common issues.</span>
                                                <div className="mt-4 mb-2">
                                                    <Link to="http://pixelwibes.com/" className="btn btn-primary">Go to Help Centre</Link>
                                                </div>
                                                <div className="dividers-block"></div>
                                        ...
                                        <div className="card bg-info-light mb-3">
                                            <div className="card-body d-flex align-items-center justify-content-center flex-column">
                                                <div className="preview-pane text-center">
                                                    ...
                                                    <Link to="http://pixelwibes.com/" className="fw-bold fs-6 mt-2 d-flex justify-content-center color-defult ">Chat with us</Link>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="card bg-lightyellow">
                                            <div className="card-body d-flex align-items-center justify-content-center flex-column">
                                                <div className="preview-pane text-center">
                                                    ...
                                                    <Link to="mailto:pixelwibes@gmail.com" className="fw-bold  fs-6 mt-2 d-flex justify-content-center color-defult ">Email us</Link>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
