                                    ...
                                    <Col sm={12}>
                                        <div className="px-4 py-3 py-md-4">
                                            ...
                                            <Nav className="nav nav-pills justify-content-between text-center" role="tablist">
                                                <Nav.Link className="flex-fill rounded border-0 nav-link " eventKey='first' to="#chat-recent">Chat</Nav.Link>
                                                <Nav.Link className="flex-fill rounded border-0 nav-link" eventKey='second' to="#chat-groups" >Ecommerce Groups</Nav.Link>
                                                <Nav.Link className="flex-fill rounded border-0 nav-link" eventKey='third' to="#chat-contact" >Contact</Nav.Link>
                                            </Nav>
                                        </div>
                                    </Col>
                                    <Col sm={12}>
