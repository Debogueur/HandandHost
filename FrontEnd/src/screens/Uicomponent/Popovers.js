            ...
            <div className="col-12">
                <div className="card p-4 bd-content">
                    ...
                    <div className="alert alert-danger" role="alert">
                        <strong>Popovers</strong> for more bootstrao components <Link to="https://v5.getbootstrap.com/docs/5.0/components/popovers/"  rel="noopener noreferrer">Bootstrap Popovers documentation <i className="fa fa-external-link"></i></Link>
                    </div>
                    <ul>
                        <li>Popovers rely on the 3rd party library <Link to="https://popper.js.org/">Popper.js</Link> for positioning. You must include <Link to="https://cdn.jsdelivr.net/npm/popper.js@1.16.1/dist/umd/popper.min.js">popper.min.js</Link> before bootstrap.js or use <code>bootstrap.bundle.min.js</code> / <code>bootstrap.bundle.js</code> which contains Popper.js in order for popovers to work!</li>
                        <li>Popovers require the <Link to="https://v5.getbootstrap.com/docs/5.0/components/tooltips/">tooltip plugin</Link> as a dependency.</li>
