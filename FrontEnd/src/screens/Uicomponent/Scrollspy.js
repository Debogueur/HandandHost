            ...
            <div className="col-12">
                <div className="card p-4 bd-content ps-lg-4">
                    ...
                    <div className="alert alert-danger" role="alert">
                        <strong>Scrollspy</strong> for more bootstrao components <Link to="https://v5.getbootstrap.com/docs/5.0/components/scrollspy/" rel="noopener noreferrer">Bootstrap Scrollspy documentation <i className="fa fa-external-link"></i></Link>
                    </div>
                    <ul>
                        <li>It must be used on a Bootstrap <Link to="https://v5.getbootstrap.com/docs/5.0/components/navs/">nav component</Link> or <Link to="https://v5.getbootstrap.com/docs/5.0/components/list-group/">list group</Link>.</li>
