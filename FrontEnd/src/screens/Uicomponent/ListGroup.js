            ...
            <div className="col-12">
                <div className="card p-4 bd-content">
                    ...
                    <div className="alert alert-danger" role="alert">
                            <strong>List group</strong> for more bootstrao components <Link to="https://v5.getbootstrap.com/docs/5.0/components/list-group/"  rel="noopener noreferrer">Bootstrap List group documentation <i className="fa fa-external-link"></i></Link>
                    </div>
                    <FlushListGroup />
                    <ContextualListGroup />
                </div>
