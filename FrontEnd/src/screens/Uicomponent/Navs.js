            ...
            <div className="col-12">
                <div className="card p-4 bd-content">
                    ...
                    <div className="alert alert-danger" role="alert">
                        <strong>Navs</strong> for more bootstrao components <Link to="https://v5.getbootstrap.com/docs/5.0/components/navs/#javascript-behavior"  rel="noopener noreferrer">Bootstrap Navs documentation <i className="fa fa-external-link"></i></Link>
                    </div>
