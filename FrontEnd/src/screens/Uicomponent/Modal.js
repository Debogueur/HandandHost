            ...
            <div className="col-12">
                <div className="card p-4 bd-content">
                    ...
                    <div className="alert alert-danger" role="alert">
                            <strong>Modal</strong> for more bootstrao components <Link to="https://v5.getbootstrap.com/docs/5.0/components/modal/"  rel="noopener noreferrer">Bootstrap Modal documentation <i className="fa fa-external-link"></i></Link>
                    </div>
                    <ul>
                            ...
                            <li>Once again, due to <code>position: fixed</code>, there are some caveats with using modals on mobile devices. <Link to="https://v5.getbootstrap.com/docs/5.0/getting-started/browsers-devices/#modals-and-dropdowns-on-mobile">See our browser support docs</Link> for details.</li>
                            <li>Due to how HTML5 defines its semantics, <Link to="https://developer.mozilla.org/en-US/docs/Web/HTML/Element/input#attr-autofocus">the <code>autofocus</code> HTML attribute</Link> has no effect in Bootstrap modals. To achieve the same effect, use some custom JavaScript:</li>
                    </ul>
                    <div className="mb-5">
