            ...
            <div className="container-xxl">
                <div className="row g-3 mb-3 row-cols-1 row-cols-sm-2 row-cols-md-2 row-cols-lg-2 row-cols-xl-4">
                    {DashboardStatusData.map((d, i) => (
                        <div key={`statuscard-${i}`} className="col">
                                <div className={`${d.bgClass} alert mb-0`}>
                                    <div className="d-flex align-items-center">
                                    <div className={`avatar rounded no-thumbnail ${d.iconBgClass} text-light`}>
                            ...
                            <Col sm={12}>
                                <div className="tab-filter d-flex align-items-center justify-content-between mb-3 flex-wrap">
                                    <Nav variant="pills" className="nav nav-tabs tab-card tab-body-header rounded  d-inline-flex w-sm-100">
                                        <Nav.Item className="nav-item"><Nav.Link className="nav-link " eventKey="first" to="#summery-today">Today</Nav.Link></Nav.Item>
                                        <Nav.Item className="nav-item"><Nav.Link className="nav-link" eventKey="second" to="#summery-week">Week</Nav.Link></Nav.Item>
                                        <Nav.Item className="nav-item"><Nav.Link className="nav-link" eventKey="third" to="#summery-month">Month</Nav.Link></Nav.Item>
                                        <Nav.Item className="nav-item"><Nav.Link className="nav-link" eventKey="fourth" to="#summery-year">Year</Nav.Link></Nav.Item>
                                    </Nav>
                                ...
                                <Tab.Content className="tab-content mt-1">
                                    <Tab.Pane eventKey="first" className="tab-pane fade show" id="summery-today">
                                        <div className="row g-1 g-sm-3 mb-3 row-deck">
                                            {TodayData.map((d, i) => (
                                                <div key={`todaydata-${i}`} className="col-xl-4 col-lg-4 col-md-4 col-sm-6">
                                                        <div className="card">
                                    ...
                                    <Tab.Pane eventKey="second" className="tab-pane fade show" id="summery-week">
                                        <div className="row g-3 mb-4 row-deck">
                                            {WeekData.map((d, i) => (
                                                <div key={`weekdata-${i}`} className="col-xl-4 col-lg-4 col-md-4 col-sm-6">
                                                        <div className="card">
                                                            <div className="card-body py-xl-4 py-3 d-flex flex-wrap align-items-center justify-content-between">
                                                                <div className="left-info">
                                                                    <span className="text-muted">{d.title}</span>
                                    ...
                                    <Tab.Pane eventKey="third" className="tab-pane fade show" id="summery-month">
                                        <div className="row g-3 mb-4 row-deck">
                                            {MonthData.map((d, i) => (
                                                <div key={`monthdata-${i}`} className="col-xl-4 col-lg-4 col-md-4 col-sm-6">
                                                        <div className="card">
                                                            <div className="card-body py-xl-4 py-3 d-flex flex-wrap align-items-center justify-content-between">
                                                                <div className="left-info">
                                                                    <span className="text-muted">{d.title}</span>
                                                                <div><span className="fs-4 fw-bold me-2">{d.value}</span></div>
                                                                </div>
                                                                <div className="right-icon">
                                                                <i className={d.iconClass}></i>
                                                            </div>
                                    ...
                                    <Tab.Pane eventKey="fourth" className="tab-pane fade show" id="summery-year">
                                        <div className="row g-3 mb-4 row-deck">
                                            {YearData.map((d, i) => (
                                                <div key={`yeardata-${i}`} className="col-xl-4 col-lg-4 col-md-4 col-sm-6">
                                                        <div className="card">
                                                            <div className="card-body py-xl-4 py-3 d-flex flex-wrap align-items-center justify-content-between">
                                                                <div className="left-info">
                                                                    <span className="text-muted">{d.title}</span>
