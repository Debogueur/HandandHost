                        ...
                        <div className="card-body">
                            <div className="checkout-steps">
                                <ul id="accordionExample">
                                    <li>
                                        <section>
                                            <Link to='#!' onClick={() => { setFirstCollapse( !firstCollapse ) }} aria-expanded={firstCollapse}>
                                    ...
                                    <li>
                                        <section>
                                            <Link to='#!' onClick={() => { setSecondCollapse(!secondCollapse ) }} aria-expanded={secondCollapse}>
